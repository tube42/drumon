...
import static se.tube42.drum.data.Constants.COLOR_BG;
import static se.tube42.drum.data.Constants.COLOR_MARKER;
import static se.tube42.drum.data.Constants.COLOR_PADS;
import static se.tube42.drum.data.Constants.COLOR_SELECTORS;
import static se.tube42.drum.data.Constants.COLOR_VOICES;
...
import static se.tube42.drum.data.Constants.ICON_44;
import static se.tube42.drum.data.Constants.ICON_A;
import static se.tube42.drum.data.Constants.ICON_B;
import static se.tube42.drum.data.Constants.ICON_COMPRESS;
import static se.tube42.drum.data.Constants.ICON_DELAY;
import static se.tube42.drum.data.Constants.ICON_FILTER;
import static se.tube42.drum.data.Constants.ICON_LOFI;
import static se.tube42.drum.data.Constants.ICON_METRONOME;
import static se.tube42.drum.data.Constants.ICON_NOTE4;
import static se.tube42.drum.data.Constants.ICON_PAUSE;
import static se.tube42.drum.data.Constants.ICON_PLAY;
import static se.tube42.drum.data.Constants.LONGPRESS_DELAY;
import static se.tube42.drum.data.Constants.MAX_TEMPO_MUL;
import static se.tube42.drum.data.Constants.MEASURE_34;
import static se.tube42.drum.data.Constants.MEASURE_68;
import static se.tube42.drum.data.Constants.MEASURE_88;
import static se.tube42.drum.data.Constants.MIN_TEMPO_MUL;
import static se.tube42.drum.data.Constants.PADS;
import static se.tube42.drum.data.Constants.SELECTORS;
import static se.tube42.drum.data.Constants.SELECTOR_ICONS;
import static se.tube42.drum.data.Constants.TILE_BUTTON0;
import static se.tube42.drum.data.Constants.TILE_PAD0;
import static se.tube42.drum.data.Constants.TILE_PAD1;
import static se.tube42.drum.data.Constants.TOOLS;
import static se.tube42.drum.data.Constants.TOOL_FX_COMP;
import static se.tube42.drum.data.Constants.TOOL_FX_DELAY;
import static se.tube42.drum.data.Constants.TOOL_FX_FILTER;
import static se.tube42.drum.data.Constants.TOOL_FX_LOFI;
import static se.tube42.drum.data.Constants.TOOL_ICONS;
import static se.tube42.drum.data.Constants.TOOL_MISC_PAUSE;
import static se.tube42.drum.data.Constants.TOOL_MISC_SAVE;
import static se.tube42.drum.data.Constants.TOOL_SEQ_AB;
import static se.tube42.drum.data.Constants.TOOL_SEQ_CLEAR;
import static se.tube42.drum.data.Constants.TOOL_SEQ_MEASURE;
import static se.tube42.drum.data.Constants.TOOL_SEQ_SHUFFLE;
import static se.tube42.drum.data.Constants.TOOL_TEMPO_DETECT;
import static se.tube42.drum.data.Constants.TOOL_TEMPO_MUL;
import static se.tube42.drum.data.Constants.TOOL_TEMPO_SET;
import static se.tube42.drum.data.Constants.VOICES;
import static se.tube42.drum.data.Constants.VOICE_ICONS;
...
public class DrumScene extends Scene implements SequencerListener {
    ...
    private void msg_show(String str, int sy) {
